...
typedef struct
{
    ...
    int I_BEAMREAD;
    int IPROC;
    int ISDME; //flag to generate according to SDME PARAMETERS
    int IENABLE_DEBUG;
...
public:
    ...
    /*! \brief returns the VM generation (according to SDME(1) or NOT (0) */
    int getSDME() const {
        return paramStruct.ISDME;
    };
    int getDEBUG() const {
        return paramStruct.IENABLE_DEBUG;
    };
