...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (paramMan->getKeyContents( "ENABLE_DEBUG" ).at ( 1 ) == "1" || paramMan->getDEBUG()==1 )
    {
      ...
      cout <<" COS(th)  "   << setprecision (5) << setw( 8)<<cos_the
	   ...
	   <<" beam q   "   << setprecision (0) << setw( 8)<<beam_charge     
...
{
    bookMan->addHBook1D(&weight     ,&event->getStruct()->dummyW,100, 0.00,1.00,"weight (Rho0)");
    bookMan->addHBook1D(&weight_sdme,&event->getStruct()->dummyW,100,-0.01,0.15,"weight SDME (Rho0)");
...
bool HPhysicsGenRHO::generateMesonMass()
{
    ...
    m_meson = (1.1-2*hepconst::mpic) * r + 2*hepconst::mpic;
    double qcms=sqrt(pow((        m_meson/2),2)-hepconst::w2pic);
    double qrho=sqrt(pow((hepconst::mRho0/2),2)-hepconst::w2pic);
    double grho=hepconst::gRho0 * pow((qcms/qrho),3) * (hepconst::mRho0/m_meson);
    double prob=m_meson*hepconst::mRho0*grho*hepconst::gRho0 / ( pow((pow(m_meson,2)-pow(hepconst::mRho0,2)),2)+pow(hepconst::mRho0,2)*pow(grho,2));
    r = myRandom->flat();
...
///////////////////////////////////////////////////////////////////////////////////////
double HPhysicsGenRHO::phi_vm( HLorentzVector  LzVecMu0, HLorentzVector LzVecMu1, HLorentzVector LzVecOut1, HLorentzVector  LzVecOut2, HLorentzVector  pr_r, int i4)
{
...
/////////////////////////////////////////////////////////////////////////////
double HPhysicsGenRHO::PHI_VM(HLorentzVector  LzVecMu0, HLorentzVector LzVecMu1, HLorentzVector LzVecOut1, HLorentzVector  LzVecOut2, int i4)
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
// azym for pion from rho
// TRENTO CONVENTION .....................
/////////////////////////////
double HPhysicsGenRHO::PHI_PI(HLorentzVector  LzVecMu0, HLorentzVector LzVecMu1, HLorentzVector LzVecOut1, HLorentzVector  LzVecOut2, int i4)
{
  //       LzVecOutX --- pion  
  const double M_Pr = 0.93827203; // proton mass
...
/////////////////////////////////////////////////////////////////////////
double   HPhysicsGenRHO::sdme(double cos_t, double phi_d, double phi_m, int ii){
...
//   ii sign of beam 
  ...
  sd[ 0]= 0.4993;  sd[ 1]= 0.0563;  sd[ 2]=-0.0160;  sd[ 3]=-0.0204;
  sd[ 4]=-0.0360;  sd[ 5]=-0.0482;  sd[ 6]= 0.2007;  sd[ 7]= 0.0495;
  sd[ 8]=-0.2001;  sd[ 9]= 0.0037;  sd[10]= 0.1367;  sd[11]= 0.1559;
  sd[12]=-0.0006;  sd[13]=-0.1393;  sd[14]= 0.0009;  sd[15]= 0.0049;
  sd[16]= 0.0355;  sd[17]= 0.0162;  sd[18]= 0.0072;  sd[19]= 0.0032;
  sd[20]= 0.0277;  sd[21]= 0.0366;  sd[22]= 0.0001;
...
/////////////////////////////////////////////////////////////////////////////
double  HPhysicsGenRHO::cos_theta_vm(HLorentzVector LzVecOut1, HLorentzVector LzVecOut2, HLorentzVector pr_r,   int i4)
{
  double ss=0. ;
  ...
  LzVecOut= LzVecOut1+LzVecOut2;
  lv1= LzVecOut1.Vect(); 
  b = - LzVecOut.BoostVector();                  // boost vector of             p1+p2 system
  HLorentzVector lv1p(LzVecOut1); lv1p.Boost(b); // transform p1     4vector to p1+p2 system
  HLorentzVector lvr(pr_r); lvr.Boost(b);        // transform proton 4vector to p1+p2 system
