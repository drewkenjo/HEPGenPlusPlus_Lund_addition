...
inline double getWsq(double _qsq,double _xbj){double m = 0.938; return sqrt(_qsq*(1.-_xbj)/_xbj + pow(m,2.));}

/*!  \brief returns xbj */
inline double getXbj(double _qsq,double _w){double m = 0.938; return -_qsq/(pow(m,2.0)-pow(_w,2.0)-_qsq);}
